          ...
          <div className="mt-6 text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 btn-primary-gradient px-6 py-4 rounded-lg text-lg font-button font-semibold text-primary-foreground hover:opacity-90 transition-opacity"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-4 rounded-lg text-lg font-button font-semibold text-foreground border border-foreground/20 hover:bg-foreground/10 transition-colors"
              >
