      ...
      <div className="max-w-xl mx-auto text-center">
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="card-gradient border border-border/50 rounded-xl p-6 space-y-4">
            ...
            <button
              type="submit"
              className="w-full btn-primary-gradient py-3 rounded-lg font-semibold text-primary-foreground hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
            >
