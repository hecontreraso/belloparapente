    ...
    <section className="section-padding">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="rounded-xl overflow-hidden border border-border/50 aspect-video">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.0!2d-75.5449!3d6.3386!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e4428dfb80fad05%3A0x42137cfcc7b53b56!2sBello%20Parapente!5e0!3m2!1ses!2sco!4v1"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
