    ...
    <section className="section-padding">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="rounded-xl overflow-hidden border border-border/50 aspect-video">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63428.08375454088!2d-75.56!3d6.3!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e4429c8b3b4b3b7%3A0x1234567890!2sSan+F%C3%A9lix%2C+Bello%2C+Antioquia!5e0!3m2!1sen!2sco!4v1"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
