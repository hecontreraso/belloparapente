    ...
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 md:px-8 py-4 bg-background/80 backdrop-blur-md border-b border-border/50">
      ...
      <div className="flex items-center gap-3 md:gap-6">
        ...
        <a
          ...
          className="hidden md:inline-flex btn-primary-gradient px-5 py-2.5 rounded-lg text-sm font-semibold text-primary-foreground hover:opacity-90 transition-opacity"
        >
          {t("Book Now", "Reservar")}
        </a>
      </div>
